        ...
        onPress={() => {
          ...
          if (contactos.length === 0) {
            setErrorModal({
              ...
              mensaje: `No tenés contactos de emergencia registrados para ${familiar.nombre}. Cargalos en 'Identidad y contacto' para poder enviarles una alerta.`,
            });
          } else {
        ...
        <Pressable style={styles.modalOverlay} onPress={() => setIsAlertModalVisible(false)}>
          <Pressable style={styles.alertModalContainer} onPress={() => {}}>
            ...
            <Text style={styles.alertModalSubtitle}>
              Compartí la información médica de {familiar.nombre} con sus contactos de emergencia:
            </Text>
            ...
            <Pressable
              ...
              onPress={() => {
                ...
                const cNombre = `${familiar.nombre} ${familiar.apellido}`.trim();
                let msg = `🚨 *MENSAJE DE EMERGENCIA* 🚨\n\nHola, necesito ayuda para mi familiar: *${cNombre}*.\n\n*Datos médicos de ${cNombre}:*\n`;
